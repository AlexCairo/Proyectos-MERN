    ...
    <BrowserRouter>
      <AppProvider>
        ...
        <Routes>
          ...
          <Route path='/categorias' element={<AuthGuard component={CategoriaPage} />} />
          <Route path='/platos' element={<AuthGuard component={PlatoPage} />} />
          <Route path='/pedidos' element={<AuthGuard component={PedidoPage} />} />
          <Route path='/cocina' element={<AuthGuard component={CocinaPage} />} />
